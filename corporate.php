  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-10 col-xs-offset-1 lead-text opensans">
		...
		<p class="lead">Any UM-Ann Arbor student interested in our corporate partners may be qualified to attend events. Most events are open to the CoE public but some require pre-screening conducted by our corporate team or are invite-only. Brothers in Theta Tau are offered multiple opportunities to network with the companies listed below and many others, such as Apple, Johnson & Johnson, and Ford. If you are interested in these perks provided by Theta Tau, please visit our <a href="https://thetatauthetagamma.com/rush.php">Rush page</a>. For any corporate questions, contact us at <a href="mailto:tht-corporate@umich.edu">tht-corporate@umich.edu.</a></p>
        ...
        <p class="lead">Here is a list up events that we have for the Fall 2017 recruiting cycle: </p>
